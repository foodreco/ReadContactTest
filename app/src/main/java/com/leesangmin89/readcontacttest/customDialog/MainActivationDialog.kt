...
import com.leesangmin89.readcontacttest.databinding.FragmentMainActivationBinding
import com.leesangmin89.readcontacttest.main.CountNumbers
import com.leesangmin89.readcontacttest.main.MainViewModel
...
//        활성화도는 어떻게 계산되는지?
        ...
        binding.btnExplanation.setOnClickListener {
            Toast.makeText(context, "통화 추천 수가 낮을수록 활성화도가 올라갑니다.\n알람 지정 그룹과 활발하게 교류하세요.", Toast.LENGTH_LONG).show()
        }
